            ...
            <div key={id} style={{ background: '#0D0C10', border: `1px solid ${url ? '#6BAE9430' : '#1A1820'}`, borderRadius: 14, padding: '16px 18px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  {url ? (
                    <>
                      <div style={{ fontSize: 12, color: '#6BAE94', fontWeight: 600 }}>✓ Uploaded</div>
                      <a href={url} target="_blank" rel="noopener noreferrer" style={{ background: '#6BAE9420', border: '1px solid #6BAE9440', color: '#6BAE94', borderRadius: 8, padding: '6px 12px', fontSize: 12, textDecoration: 'none', cursor: 'pointer' }}>Watch</a>
                    </>
                  ) : (
                    <div style={{ fontSize: 12, color: '#D4A853' }}>Not uploaded</div>
                  )}
